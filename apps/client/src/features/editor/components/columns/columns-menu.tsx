  ...
  return (
    ...
    >
      <div className={classes.toolbar}>
        ...
        <Tooltip position="top" label={t("Default") }>
          <ActionIcon
            onClick={() => setWidthMode("normal")}
            size="lg"
            aria-label={t("Default")}
            variant="subtle"
            className={clsx({ [classes.active]: editorState?.isNormal })}
          >
            N
          </ActionIcon>
        </Tooltip>

        <Tooltip position="top" label={t("Wide center") }>
          <ActionIcon
            onClick={() => setWidthMode("wide")}
            size="lg"
            aria-label={t("Wide center")}
            variant="subtle"
            className={clsx({ [classes.active]: editorState?.isWide })}
          >
            W
          </ActionIcon>
        </Tooltip>
