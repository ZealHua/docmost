...
export function getFileIcon(filepath: string, size: string = 'size-6'): ReactNode {
  const ext = getFileExtension(filepath);
...
export function urlOfArtifact({ filepath, sessionId, download }: ArtifactUrlOptions): string {
